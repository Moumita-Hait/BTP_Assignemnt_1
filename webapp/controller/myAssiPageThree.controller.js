sap.ui.define([
    ...
    function (Controller) {
        ...
        return Controller.extend("myassigmnent.myassigmnent.controller.myAssiPageThree", {
            onInit: function () {
                this.oRouter = sap.ui.core.UIComponent.getRouterFor(this);
                this.oRouter.getRoute("myAssiPageThree").attachPatternMatched(this.onRouteMatched, this);
            },

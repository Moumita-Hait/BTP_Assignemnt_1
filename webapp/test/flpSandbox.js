		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "myassigmnent",
									"targetURL": "#myassigmnentmyassigmnent-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"myassigmnentmyassigmnent-display": {
								"semanticObject": "myassigmnentmyassigmnent",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=myassigmnent.myassigmnent",
									"url": sap.ui.require.toUrl("myassigmnent/myassigmnent")
								}
							}
						}
					}
